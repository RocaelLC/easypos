...
export default function ModificadoresPage() {
  ...
  // Opciones (lista temporal antes de guardar)
    ...
    <div className="p-4 space-y-4">
      <div>
        ...
        <p className="text-sm text-neutral-400">
          Crea grupos (Tamaño, Toppings, Leche...) y sus opciones. Puedes ligar una opción a un insumo para descontar inventario.
        </p>
      </div>
      ...
      <div className="rounded-2xl border border-neutral-800 bg-neutral-950 p-4 space-y-3">
        ...
        <div className="grid md:grid-cols-6 gap-2">
          <div className="md:col-span-2">
            ...
            <div className="text-xs text-neutral-500 mt-1">Normaliza: <span className="text-neutral-300">{normalizeId(gid || "…")}</span></div>
          </div>
